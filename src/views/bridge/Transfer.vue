...
export default {
  ...
  watch: {
    ...
    'web3State.solana.solanaAddress': function (newValue) {
      console.log("web3State.solana.solanaAddress", newValue)
    },
  ...
  methods: {
    ...
    async fillAddress() {
      ...
      if ([CHAIN_ID.solana, CHAIN_ID.solana].includes(transferDataState.fromChainID)) {
        console.log("solana transfer 1040")
        ...
        console.log("solana transfer 1043")
      }
    },
    ...
    async specialProcessing(oldFromChainID, oldToChainID) {
      ...
      if (fromChainID === CHAIN_ID.solana || fromChainID === CHAIN_ID.solana_test || toChainID === CHAIN_ID.solana || toChainID === CHAIN_ID.solana_test) {
        console.log("solana 1587")
      }
    ...
    async sendTransfer() {
      ...
      if (!walletIsLogin.value) {
        ...
        console.log('solana 2044')
        const walletAddress = ((isCrossAddress || toChainID === CHAIN_ID.starknet || toChainID === CHAIN_ID.starknet_test || toChainID === CHAIN_ID.solana || toChainID ===  CHAIN_ID.solana_test) ? crossAddressReceipt : compatibleGlobalWalletConf.value.walletPayload.walletAddress).toLowerCase();
        // sendTransfer
