        ...
        <div class="maker-content">
          <div style="margin-bottom: 30px">
            <div class="maker-desc">
              ...
              <div>Become a maker and configure node parameters.</div>
            </div>
            <div class="maker-desc">
              <div class="point">2</div>
              <div>Run nodes to ensure instant response to users.</div>
            </div>
            <div class="maker-desc">
            ...
            <div class="maker-desc">
              ...
              <div>Experience arbitration process when transactions fail.</div>
            </div>
          </div>

          <div>
            <div class="maker-line">
              <SvgIconThemed icon="docs" class="maker-icon" /><span
                :class="isLightMode ? 'maker-link' : 'maker-link-dark'"
                @click="openUrl(1)"
                >Docs for Market Maker</span
              >
            </div>
            <div class="maker-line">
              <SvgIconThemed icon="discord" class="maker-icon" /><span
                :class="isLightMode ? 'maker-link' : 'maker-link-dark'"
                @click="openUrl(2)"
  ...
  methods: {
    ...
    openUrl (type) {
      if (type === 1) {
        ...
        window.open('https://discord.gg/FbztTBvnBT', '_blank')
      } else if (type === 99) {
