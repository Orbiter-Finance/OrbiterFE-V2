            ...
            >
                        ...
                        <div class="data">
                            {{
                                isEmpty(scope.row.total_accounts)
                                    ? '-'
                                    : numeral(scope.row.total_accounts).format(
                                          '0,0'
                                      )
                            }}
                        </div>
                ...
                >
                    <template v-slot:header>
                        ...
                        >
                            <div class="TVL-desc">
                                Total Value Locked in Rollups & Types of
                                cryptocurrencies.
                                <a
                ...
                >
                    <template v-slot="scope">
                        <div class="new-data">
                            {{
                                isEmpty(
                                    scope.row.active_accounts[currentFilter]
                                )
                                    ? '-'
                                    : numeral(
                                          scope.row.active_accounts[
                                              currentFilter
                                          ]
                                      ).format('0,0')
                            }}
                        ...
                        <div class="new-data">
                            {{
                                isEmpty(scope.row.new_accounts[currentFilter])
                                    ? '-'
                                    : numeral(
                                          scope.row.new_accounts[currentFilter]
                                      ).format('0,0')
                            }}
                        </div>
                    </template>
        ...
        handleRoute({ floater }) {
            ...
            if (floater) {
                if (newQuery?.floater !== floater) {
                    ...
                    this.$refs.rolluoDetail.show(
                        this.indexTableData.find(
                            (item) => item.rollup_name === floater
                        ),
                        true
                    )
                    const suffixArr = []
                    ...
                    const row = this.indexTableData.find(
                        (item) => item.rollup_name === floater
                    )
                    if (row) {
