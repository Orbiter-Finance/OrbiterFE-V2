            ...
            >
                ...
                >
                    <template v-slot="scope">
                        <div class="new-contract">
                            ...
                            <div
                                class="address"
                                :title="scope.row.contract_address"
                            >
                                {{
                                    shortenAddress(
                    ...
                    <template v-slot:header>
                        ...
                        >
                            <div class="user-age-desc">
                                Statistics for all users. " Users Age " refers
                                to the cumulative days since users started the
                                first transaction on the mainnet.
                                <a
                ...
                >
                    <template v-slot="scope">
                        <div class="data">
                            {{
                                numeral(scope.row['24h_active_users']).format(
                                    '0,0'
                                )
                            }}
                        </div>
                ...
                >
                    <template v-slot="scope">
                        <div class="data">
                            {{
                                numeral(scope.row['24h_new_users']).format(
                                    '0,0'
                                )
                            }}
                        </div>
                ...
                >
                    <template v-slot="scope">
                        <div class="data">
                            {{
                                numeral(scope.row['24h_interactions']).format(
                                    '0,0'
                                )
                            }}
                        </div>
...
.contracts-wrapper {
    ...
    .table {
        ...
        .el-table th.el-table__cell:nth-child(2) > .cell,
        .el-table th.el-table__cell:nth-child(3) > .cell {
