                ...
                >
                    <template v-slot="scope">
                        <div class="data">
                            {{
                                numeral(
                                    scope.row[currentFilter].active_users
                                ).format('0,0')
                            }}
                        </div>
                    </template>
                ...
                >
                    <template v-slot="scope">
                        <div class="data">
                            {{
                                numeral(
                                    scope.row[currentFilter].new_users
                                ).format('0,0')
                            }}
                        </div>
                    </template>
                ...
                <el-table-column prop="new_users_age" width="140" align="right">
                    <template v-slot:header>
                        ...
                        >
                            <div class="new-user-age-desc">
                                Statistics of all users. “Users Age” refers to
                                the cumulative days since users started the
                    ...
                    <template v-slot="scope">
                        <div class="data">
                            {{
                                numeral(
                                    scope.row[currentFilter].new_users_age
                                ).format('0,0')
                            }}
                        </div>
                    </template>
                ...
                >
                    <template v-slot="scope">
                        <div class="data">
                            {{
                                numeral(
                                    scope.row[currentFilter].interactions
                                ).format('0,0')
                            }}
                        </div>
                    </template>
