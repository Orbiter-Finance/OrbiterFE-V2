        ...
        <div class="dapp-daily-data">
            ...
            <div class="title">
                ...
                {{
                    !isMobile &&
                    baseDappDailyData &&
                    baseDappDailyData.update_time
                        ? ',' +
                          dateFormat(
                              (baseDappDailyData.update_time - 60 * 60 * 24) *
                                  1000,
                              'yyyy-MM-dd'
                          )
                        : isMobile
            ...
            <div
                :class="
                    tableData.find((item) => item.rank === 0)
                        ? 'table'
                        : 'table-none'
                "
            >
