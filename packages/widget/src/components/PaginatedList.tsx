...
import usePaginationWithEllipsis from '../hooks/usePaginationWithEllipsis'
    ...
    return (
        <div className='w-full flex justify-center items-center'>
            <div className='flex justify-center items-center'>
                <div className='w-10 h-10 p-1.5 flex justify-center items-center'>
                    <button className={
                        cn('w-full h-full rounded-[0.25rem] bg-[var(--o-color-gray-800)] flex justify-center items-center')
                ...
                {pageNumbers.map((pageNumber, index) => (
                    <div className='w-10 h-10 p-1.5 flex justify-center items-center'>
                        <button
                            ...
                            className={
                                cn('w-full h-full rounded-[0.25rem]', pageNumber === currentPage ? "bg-[var(--o-color-brand-900)] text-[var(--o-color-brand-500)] o-font-500" : "bg-[var(--o-color-gray-800)] text-[var(--o-color-gray-600)] o-font-400")
                            }
                        >
                            {pageNumber}
                        </button>
                ...
                <div className='w-10 h-10 p-1.5 flex justify-center items-center'>
                    ...
                    <button
                        className={
                            cn('w-full h-full rounded-[0.25rem] bg-[var(--o-color-gray-800)] flex justify-center items-center', currentPage === totalPages ? "text-[var(--o-color-gray-600)]" : "text-[var(--o-color-gray-200)]")
                        }
